...
public class ControllerLogAspect {
    ...
    public void logControllerMethodEntry(JoinPoint joinPoint) {
        ...
        log.info("Spring Consumer Two [Controller] method: {} start, args: {}", joinPoint.getSignature().getName(), arguments);
    }

    @After("@within(org.springframework.web.bind.annotation.RestController)")
    public void logControllerMethodEnding(JoinPoint joinPoint) {
        log.info("Spring Consumer Two [Controller] method: {} end.", joinPoint.getSignature().getName());
    }
}
